...
(function (XG) {
  ...
  var BODY = [
    ...
    { id: 'body_stream', need: ['AQUATIC'], weight: 1.3, emit: ['BILATERAL', 'RADIAL'], inst: I.MORPH,
      title: 'Streamlined hydrobody', reveal: 'Fusiform body, fin- or mantle-driven propulsion, jelly-supported tissues. Symmetry leans radial where currents come from everywhere, bilateral where it swims.' },
